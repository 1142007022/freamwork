            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form method="post" id="saveForm">
                        ...
                        <div class="form-group">
                            <label>角色代号</label>
                            <input type="text" name="rolesCode" value="${roles.rolesCode} " class="form-control">
                        </div>
                                ...
                                <c:choose>
                                    <c:when test="${entry.key.parentId == 0}">
                                        <tr class="treegrid-${entry.key.id} treegrid-expanded">
                                            <th>
                                                <input type="checkbox" name="powerIds" ${entry.value ? 'checked' : ''} value="${entry.key.id}">
                                            </th>
                                            <td>${entry.key.powerName}</td>
                                            <td>${entry.key.powerCode}</td>
                                            <td>${entry.key.url}</td>
                                            <td>${entry.key.powerType}</td>
