			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						...
						<div class="box-tools">
							<a class="btn btn-primary btn-sm" href="/customer/my"><i
								class="fa fa-arrow-left"></i> 返回列表</a> <a
								class="btn bg-purple btn-sm"
								href="/customer/my/edit?id=${customer.id}"><i
								class="fa fa-pencil"></i> 编辑</a>
							<button class="btn bg-orange btn-sm" id="transBtn">
								<i class="fa fa-exchange"></i> 转交他人
							</button>
							<button class="btn bg-maroon btn-sm" id="publicBtn">
								<i class="fa fa-recycle"></i> 放入公海
							</button>
		...
		$(function(){
			...
			$("#publicBtn").click(function(){
				layer.confirm("确定要把客户放入公海么?",function(){
					layer.close();
					location.href="/customer/my/change?custId=" + custId + "&type=" + makePublic;					
				});
			});
			...
			$("#saveBtn").click(function(){
				...
				layer.confirm("确定要转交给" + toAccountName + "么?",function(){
					layer.close();
					location.href="/customer/my/change?custId=" + custId +"&toAccountId=" + toAccountId;					
				});
			});
		})
