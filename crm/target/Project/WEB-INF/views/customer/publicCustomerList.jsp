	...
	<script>
		$(function() {
			...
			$("#addBtn").click(function() {
				window.location.href = "/customer/add/public";
			});
					...
					success : function(data) {
						...
						for (var i = 0; i < page.items.length; i++) {
							...
							var html = "<tr class='messages' rel='"+ customer.id +"'>"
									+ "<td><span class='name-avatar '>"
									+ customer.name.substring(0, 1)
									+ "</span></td>" + "<td>" + customer.name
									+ "</td>" + "<td>" + customer.job + "</td>"
									+ "<td>" + customer.updateTime + "</td>"
									+ "<td class='star'>" + customer.level
									+ "</td>"
									+ "<td><i class='fa fa-phone'></i>"
									+ customer.mobile + "</td>" + "</tr>";
							$("#tbody").append(html);	
							if(customer.sex == '女士'){
								//$(html).find(".name-avatar").addClass("pink");
